...
int cQueue[SIZE], front = -1, rear = -1; // declaring the queue array and front and rear variables
...
void main()
{
    ...
    while (1)
    {
        ...
        switch (choice)
        {
        case 1: // inserting the value in the queue
            printf("\nEnter the value to be insert:  ");
            scanf("%d", &value);
            enQueue(value);
            break;
        case 2: // deleting the value from the queue
            deQueue();
            break;
